...
int main()
{
	...
	// ------------------------------------
	glewInit();
	Shader ourShader("../../../src/Data/shader/camera.vs", "../../../src/Data/shader/camera.fs");
	...
	// -------------------------	
	TextureManager::Inst()->LoadTexture("../../../src/Data/Texture/1.png",0);
	TextureManager::Inst()->LoadTexture("../../../src/Data/Texture/2.jpg",1);
