...
int main()
{
	...
	TextureManager::Inst()->loadTexture("../../../src/Data/1.jpg", "test1");
	TextureManager::Inst()->loadTexture("../../../src/Data/2.jpg", "test2");
	TextureManager::Inst()->loadTexture("../../../src/Data/3.jpg", "test3");
